...
This script gets all series from DiVA Classic database and saves them to an XML file, that can be imported using the [`series-import`](./series_import.md) script.
