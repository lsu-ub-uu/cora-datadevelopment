...
This script gets all funders from DiVA Classic database and saves them to an XML file, that can be imported using the [`funders-import`](./funders_import.md) script.
