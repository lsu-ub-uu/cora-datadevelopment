...
This script gets all journals from DiVA Classic database and saves them to an XML file, that can be imported using the [`journals-import`](./journals_import.md) script.
