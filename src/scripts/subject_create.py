...
def start():
    ...
    for data_record in dataList.findall(".//DATA_RECORD"):
        ...
        relationOldNewIds, linksToEarlierIds, linksToBroaderIds = store_ids(
            data_record, createdCoraRecord
        )
...
def new_record_build(data_record):
    ...
    common_data.topicAuthorityVariant_build(
        ...
        if newId in linksToEarlierIds or newId in linksToBroaderIds:
            ...
            if newId in linksToEarlierIds:
                ...
                for earlierOldId in earlierOldIds:
                    ...
                    related_record_build(
                        nameInData, cleanedRecord, "earlier", repeatId, earlierNewId
                    )
                    repeatId += 1
