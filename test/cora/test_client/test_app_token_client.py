...
class TestAppTokenClient(unittest.TestCase):
    ...
    def test_get_auth_token_create(self):
        ...
        self.assertEqual(
            self.client.get_auth_token(), "5545e11c-7e90-4289-87d0-155bb2078f85"
        )
    ...
    def test_get_auth_token_answer_not_parsable_error(self):
        ...
        self.assertEqual(
            str(original_exception), "string indices must be integers, not 'str'"
        )
    ...
    def set_up_mock_time_for_ten_minutes_before_renew_until(self):
        ...
        ten_minutes = 10
        valid_until_minus_ten_minutes = (
            time_from_valid_until_in_response - ten_minutes * 60 * 1000
        )
            ...
            "authentication": {
                "data": {
                    "children": [
                        ...
                        {"name": "validUntil", "value": "1744703967172"},
                        {"name": "renewUntil", "value": "1744789767172"},
                        {"name": "userId", "value": "161616"},
                        {"name": "loginId", "value": "divaAdmin@cora.epc.ub.uu.se"},
                        {"name": "firstName", "value": "DiVA"},
                        {"name": "lastName", "value": "Admin"},
                        {
                            "repeatId": "1",
                            "children": [
                                {"name": "linkedRecordType", "value": "permissionUnit"},
                                {"name": "linkedRecordId", "value": "test1"},
                            ],
                            "name": "permissionUnit",
                        },
                        {
                            ...
                            "children": [
                                {"name": "linkedRecordType", "value": "permissionUnit"},
                                {"name": "linkedRecordId", "value": "test2"},
                            ],
                            "name": "permissionUnit",
                        },
                    ],
