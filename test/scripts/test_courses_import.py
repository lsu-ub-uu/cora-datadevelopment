...
@patch("scripts.courses_import.validate_record_list")
@patch("scripts.courses_import.common_data.read_source_xml")
def test_course_import_does_not_create_when_apply_false(
...
@patch("scripts.courses_import.validate_record_list")
@patch("scripts.courses_import.common_data.read_source_xml")
def test_course_import_does_not_create_when_apply_true_and_not_valid(
    mock_read_source_xml, mock_validate_record_list, mock_create_record_list
):
...
@patch("scripts.courses_import.validate_record_list")
@patch("scripts.courses_import.common_data.read_source_xml")
def test_course_import_when_apply_true_and_valid(
    mock_read_source_xml, mock_validate_record_list, mock_create_record_list
):
...
@patch("scripts.courses_import.validate_record_list")
@patch("scripts.courses_import.create_record_list")
def test_course_import_raises_error_when_invalid_source_data(
