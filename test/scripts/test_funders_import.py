...
@patch("scripts.funders_import.validate_record_list")
@patch("scripts.funders_import.create_record_list")
def test_funders_import_raises_error_when_invalid_source_data(
    mock_create_record_list, mock_validate_record_list, mock_read_source_xml
):
    funder_xml = ET.fromstring(
        """<?xml version="1.0" encoding="UTF-8"?>
        <SELECT>
            ...
            <DATA_RECORD>
                <old_id>401</old_id>
                <name_swe>Svenska sällskapet för antropologi och geografi</name_swe>
                <name_eng>The Swedish Society for Anthropology and Geography</name_eng>
                <end_date></end_date>
                <identifier_organisationNumber>802000-1551</identifier_organisationNumber>
                <identifier_doi></identifier_doi>
                <locale_swe>sv</locale_swe>
                <locale_eng>en</locale_eng>
                <funder_name_id>168</funder_name_id>
